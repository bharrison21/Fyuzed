...
from .views import SignUpView, RegisteredUsersList, ProfileView, ProfileUpdate, DeleteAccount
from . import views
...
urlpatterns = [
    ...
    path('profile/<slug:the_slug>/deleteaccount', DeleteAccount.as_view(), name='deleteaccount'),
